    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.detailSection}>
                ...
                <CustomHr width={1} />
                <Text style={styles.explanationText}>On Mon Dec 31st, AirliPay will send your salary like normal. If your salary does not exceed XAF 40 000, AirliPay will debit your account with the difference.</Text>
            </View>
